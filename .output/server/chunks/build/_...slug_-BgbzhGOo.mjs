...
import { u as useAsyncData } from './asyncData-Dx1s_PTj.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const virtual_nuxt__2Fhome_2FLek_2FDevelopment_2FMyCode_2FMyProjects_2Fportfolio_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  globalComponents,
  localComponents
    ...
    function resolveVueComponent(component) {
      ...
      if (typeof component === "string") {
        ...
        if (globalComponents.includes(pascalCase(component))) {
          ...
          const loader = () => {
            return Promise.resolve().then(() => virtual_nuxt__2Fhome_2FLek_2FDevelopment_2FMyCode_2FMyProjects_2Fportfolio_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents).then((m) => {
...
//# sourceMappingURL=_...slug_-BgbzhGOo.mjs.map
