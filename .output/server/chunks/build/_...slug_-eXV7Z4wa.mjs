import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, withAsyncContext, unref, mergeProps, computed, toRaw, resolveComponent, defineAsyncComponent, h, getCurrentInstance, reactive, watch, Text, Comment, useSSRContext } from 'vue';
...
import { b as useRoute, c as createError, t as tryUseNuxtApp, a as useRuntimeConfig } from './server.mjs';
import { u as useAsyncData } from './asyncData-BkPKB0ks.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const Alert = () => import('./Alert-BGjQUhup.mjs');
const Counter = () => import('./Counter-CpvwMHJ_.mjs');
...
const virtual_nuxt__2Fhome_2FLek_2FDevelopment_2FMyCode_2FMyProjects_2FPortifolio_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Alert,
  Counter,
  globalComponents,
    ...
    function resolveVueComponent(component) {
      ...
      if (typeof component === "string") {
        ...
        if (globalComponents.includes(pascalCase(component))) {
          ...
          const loader = () => {
            return Promise.resolve().then(() => virtual_nuxt__2Fhome_2FLek_2FDevelopment_2FMyCode_2FMyProjects_2FPortifolio_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents).then((m) => {
...
//# sourceMappingURL=_...slug_-eXV7Z4wa.mjs.map
