...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, createEventStream, getResponseStatus, getRouterParam, setHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getResponseStatusText } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import wsAdapter from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/crossws/dist/adapters/node.mjs';
import { escapeHtml } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/unhead/dist/server.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/unhead/dist/utils.mjs';
import { getIcons } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/.nuxt/nuxt-icon-server-bundle.mjs';
import localAdapter from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///home/Lek/Development/MyCode/MyProjects/portfolio/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/Lek/Development/MyCode/MyProjects/portfolio/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/Lek/Development/MyCode/MyProjects/portfolio","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/Lek/Development/MyCode/MyProjects/portfolio/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/Lek/Development/MyCode/MyProjects/portfolio/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/Lek/Development/MyCode/MyProjects/portfolio/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/Lek/Development/MyCode/MyProjects/portfolio/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/home/Lek/Development/MyCode/MyProjects/portfolio/public"
      ]
    },
    "http": {
      "domains": []
...
const _KxeHWYq8c0ynK3WZ5pbUxQczbnkdHaCKLNW5SEW0qoM = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

function _MS6YnqtbBt0QIcvf5FmFDDd5HIQUnm_9u9HTnWdpUZQ(nitroApp) {
...
const rootDir = "/home/Lek/Development/MyCode/MyProjects/portfolio";
...
const _t7evSgxRT4ywOv0e85GW97jZNDLSds9opbM4FgsGzmQ = (nitroApp) => {
...
const plugins = [
  _KxeHWYq8c0ynK3WZ5pbUxQczbnkdHaCKLNW5SEW0qoM,
_MS6YnqtbBt0QIcvf5FmFDDd5HIQUnm_9u9HTnWdpUZQ,
_t7evSgxRT4ywOv0e85GW97jZNDLSds9opbM4FgsGzmQ,
...
const getServerEntry = () => import('file:///home/Lek/Development/MyCode/MyProjects/portfolio/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///home/Lek/Development/MyCode/MyProjects/portfolio/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _Ek2nAr = defineEventHandler((event) => {
  switch (event.method) {
    case "GET":
      return getHandler();
    case "POST":
...
const _ojSgS9 = defineEventHandler((event) => {
  const nitro = useNitroApp();
...
const _C3s1bB = eventHandler(async (event) => {
  ...
  return await import('file:///home/Lek/Development/MyCode/MyProjects/portfolio/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _lazy_yjGBIO = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/__nuxt_hydration', handler: _Ek2nAr, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_hydration/sse', handler: _ojSgS9, lazy: false, middleware: false, method: undefined },
  ...
  { route: '/_fonts/**', handler: _lazy_yjGBIO, lazy: true, middleware: false, method: undefined },
  { route: '/_scripts/**', handler: _lazy_yjGBIO, lazy: true, middleware: false, method: undefined },
